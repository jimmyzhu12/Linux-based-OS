 ...
 *        Final revision. These fonts are copied from open-source
 *        website, or previous MP.
 * 
 */
...
unsigned char font_form_mp2[256][16];
unsigned char* font = (unsigned char*) cupertino;

font_t font_select[3] = {
   {8, 12, (unsigned char*) cupertino},
   {8, 8,  (unsigned char*) font8x8_basic},
   {8, 16, (unsigned char*) font_form_mp2}
};

/*
Font coded by: Jay Link, jlink@svgalib.org
Based on the Mac Plus (Geneva?)
...
/* these data are copied and pasted from MP2 */
unsigned char font_form_mp2[256][16] = {
